...
export const cityCoordinates: CityCoordinates[] = [
  ...
  // 越南主要城市
  { name: 'Da Nang', path: 'da-nang', latitude: 16.0544, longitude: 108.2022, country: 'Vietnam' },
  { name: 'Hai Phong', path: 'hai-phong', latitude: 20.8449, longitude: 106.6881, country: 'Vietnam' },
  { name: 'Can Tho', path: 'can-tho', latitude: 10.0452, longitude: 105.7469, country: 'Vietnam' },
  { name: 'Bien Hoa', path: 'bien-hoa', latitude: 10.9444, longitude: 106.8244, country: 'Vietnam' },
  { name: 'Hue', path: 'hue', latitude: 16.4637, longitude: 107.5909, country: 'Vietnam' },
  { name: 'Nha Trang', path: 'nha-trang', latitude: 12.2388, longitude: 109.1967, country: 'Vietnam' },
  { name: 'Vung Tau', path: 'vung-tau', latitude: 10.3459, longitude: 107.0843, country: 'Vietnam' },
  { name: 'Qui Nhon', path: 'qui-nhon', latitude: 13.7765, longitude: 109.2239, country: 'Vietnam' },
  { name: 'Buon Ma Thuot', path: 'buon-ma-thuot', latitude: 12.6667, longitude: 108.0500, country: 'Vietnam' },
  { name: 'Thai Nguyen', path: 'thai-nguyen', latitude: 21.5928, longitude: 105.8442, country: 'Vietnam' },
  { name: 'Thanh Hoa', path: 'thanh-hoa', latitude: 19.8067, longitude: 105.7856, country: 'Vietnam' },
  { name: 'Nam Dinh', path: 'nam-dinh', latitude: 20.4208, longitude: 106.1681, country: 'Vietnam' },
  { name: 'Vinh', path: 'vinh', latitude: 18.6733, longitude: 105.6922, country: 'Vietnam' },
  { name: 'Long Xuyen', path: 'long-xuyen', latitude: 10.3833, longitude: 105.4167, country: 'Vietnam' },
  { name: 'Rach Gia', path: 'rach-gia', latitude: 10.0167, longitude: 105.0833, country: 'Vietnam' },
  { name: 'My Tho', path: 'my-tho', latitude: 10.3603, longitude: 106.3600, country: 'Vietnam' },
  { name: 'Ca Mau', path: 'ca-mau', latitude: 9.1769, longitude: 105.1500, country: 'Vietnam' },
  { name: 'Bac Lieu', path: 'bac-lieu', latitude: 9.2833, longitude: 105.7167, country: 'Vietnam' },
  { name: 'Soc Trang', path: 'soc-trang', latitude: 9.6000, longitude: 105.9833, country: 'Vietnam' },
  { name: 'Tra Vinh', path: 'tra-vinh', latitude: 9.9333, longitude: 106.3500, country: 'Vietnam' },
  { name: 'Ben Tre', path: 'ben-tre', latitude: 10.2333, longitude: 106.3833, country: 'Vietnam' },
  { name: 'Vinh Long', path: 'vinh-long', latitude: 10.2500, longitude: 105.9667, country: 'Vietnam' },
  { name: 'Dong Thap', path: 'dong-thap', latitude: 10.5167, longitude: 105.6167, country: 'Vietnam' },
  { name: 'An Giang', path: 'an-giang', latitude: 10.5167, longitude: 105.6167, country: 'Vietnam' },
  { name: 'Kien Giang', path: 'kien-giang', latitude: 10.0167, longitude: 105.0833, country: 'Vietnam' },
  { name: 'Hau Giang', path: 'hau-giang', latitude: 9.7833, longitude: 105.4667, country: 'Vietnam' },
  { name: 'Tien Giang', path: 'tien-giang', latitude: 10.3603, longitude: 106.3600, country: 'Vietnam' },
  { name: 'Binh Duong', path: 'binh-duong', latitude: 11.1667, longitude: 106.6667, country: 'Vietnam' },
  { name: 'Tay Ninh', path: 'tay-ninh', latitude: 11.3167, longitude: 106.1000, country: 'Vietnam' },
  { name: 'Binh Phuoc', path: 'binh-phuoc', latitude: 11.7500, longitude: 106.6000, country: 'Vietnam' },
  { name: 'Dong Nai', path: 'dong-nai', latitude: 10.9444, longitude: 106.8244, country: 'Vietnam' },
  { name: 'Ba Ria-Vung Tau', path: 'ba-ria-vung-tau', latitude: 10.3459, longitude: 107.0843, country: 'Vietnam' },
  { name: 'Lam Dong', path: 'lam-dong', latitude: 11.9333, longitude: 108.4333, country: 'Vietnam' },
  { name: 'Ninh Thuan', path: 'ninh-thuan', latitude: 11.5667, longitude: 108.9833, country: 'Vietnam' },
  { name: 'Binh Thuan', path: 'binh-thuan', latitude: 10.9333, longitude: 108.1000, country: 'Vietnam' },
  { name: 'Khanh Hoa', path: 'khanh-hoa', latitude: 12.2388, longitude: 109.1967, country: 'Vietnam' },
  { name: 'Phu Yen', path: 'phu-yen', latitude: 13.7765, longitude: 109.2239, country: 'Vietnam' },
  { name: 'Dak Lak', path: 'dak-lak', latitude: 12.6667, longitude: 108.0500, country: 'Vietnam' },
  { name: 'Dak Nong', path: 'dak-nong', latitude: 12.0000, longitude: 107.6833, country: 'Vietnam' },
  { name: 'Gia Lai', path: 'gia-lai', latitude: 13.9833, longitude: 108.0000, country: 'Vietnam' },
  { name: 'Kon Tum', path: 'kon-tum', latitude: 14.3500, longitude: 108.0000, country: 'Vietnam' },
  { name: 'Quang Nam', path: 'quang-nam', latitude: 15.8833, longitude: 108.2500, country: 'Vietnam' },
  { name: 'Quang Ngai', path: 'quang-ngai', latitude: 15.1167, longitude: 108.8000, country: 'Vietnam' },
  { name: 'Binh Dinh', path: 'binh-dinh', latitude: 13.7765, longitude: 109.2239, country: 'Vietnam' },
  { name: 'Phu Tho', path: 'phu-tho', latitude: 21.3000, longitude: 105.4333, country: 'Vietnam' },
  { name: 'Vinh Phuc', path: 'vinh-phuc', latitude: 21.3167, longitude: 105.6000, country: 'Vietnam' },
  { name: 'Bac Ninh', path: 'bac-ninh', latitude: 21.1833, longitude: 106.0500, country: 'Vietnam' },
  { name: 'Hai Duong', path: 'hai-duong', latitude: 20.9333, longitude: 106.3167, country: 'Vietnam' },
  { name: 'Hung Yen', path: 'hung-yen', latitude: 20.6500, longitude: 106.0667, country: 'Vietnam' },
  { name: 'Ha Nam', path: 'ha-nam', latitude: 20.5333, longitude: 105.9167, country: 'Vietnam' },
  { name: 'Ninh Binh', path: 'ninh-binh', latitude: 20.2500, longitude: 105.9667, country: 'Vietnam' },
  { name: 'Ha Tinh', path: 'ha-tinh', latitude: 18.3333, longitude: 105.9000, country: 'Vietnam' },
  { name: 'Quang Binh', path: 'quang-binh', latitude: 17.4667, longitude: 106.6000, country: 'Vietnam' },
  { name: 'Quang Tri', path: 'quang-tri', latitude: 16.7500, longitude: 107.1833, country: 'Vietnam' },
  { name: 'Thua Thien Hue', path: 'thua-thien-hue', latitude: 16.4637, longitude: 107.5909, country: 'Vietnam' },
  { name: 'Long An', path: 'long-an', latitude: 10.6667, longitude: 106.1667, country: 'Vietnam' },
